"""Native cognis-connect emit for ghaudit — forward findings to any platform.

Maps ghaudit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    ghaudit ... --format json | ghaudit-emit --to stix
    ghaudit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
