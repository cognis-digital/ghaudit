#!/usr/bin/env sh
# Universal installer for ghaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ghaudit.git"
echo "Installing ghaudit ..."
