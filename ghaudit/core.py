"""GHAUDIT core — Audit a GitHub org's security posture (branch rules, 2FA, secrets) from an export."""
...
RULES = [
    ("GHA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("GHA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("GHA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
